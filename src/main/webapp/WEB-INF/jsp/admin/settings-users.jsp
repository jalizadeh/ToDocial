...
<div class="row">
	<div class="col-3">
		<ul class="list-group">
			<li class="list-group-item list-group-item-secondary disabled bg-light" aria-disabled="true">Administrative Settings</li>
			<a href="/admin/settings" class="list-group-item list-group-item-action">General</a>
			<a href="/admin/settings/users" class="list-group-item list-group-item-action active">Users</a>
			<a href="/admin/settings/todos" class="list-group-item list-group-item-action">Todos</a>
			<a href="/admin/settings/security" class="list-group-item list-group-item-action">Security</a>
		</ul>
	</div>
			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-4 text-center">
						<a class="btn btn-primary" href="/admin/add-user" role="button">Add a user</a>
					</div>
				</div>
