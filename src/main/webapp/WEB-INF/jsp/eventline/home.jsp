<%@ include file="../common/header.jspf" %>
	...
	<div class="row">
		<div class="col-2">
			...
			<div class="row">
				<div class="p-3 mb-3 bg-light rounded">
					<h4 class="font-italic">Popular hashtags</h4>
					<p class="mb-0">Etiam porta <em>sem malesuada magna</em> mollis euismod. Cras mattis consectetur purus sit amet fermentum. Aenean lacinia bibendum nulla sed consectetur.</p>
				  </div>
			</div>
		</div>
		...
		<div class="col">
			<div class="row">
				<div class="col-3">
					<p>Spring</p>
					<div class="row">
						<div class="col"><a class="btn btn-primary btn-sm" href="/eventline/month/1" role="button">Jan</a></div>
						<div class="col"><a class="btn btn-primary btn-sm" href="/eventline/month/2" role="button">Feb</a></div>
						<div class="col"><a class="btn btn-primary btn-sm" href="/eventline/month/3" role="button">Mar</a></div>
					</div>
				</div>
				...
				<div class="col-3">
					<p>Summer</p>
					<div class="row">
						<div class="col"><a class="btn btn-primary btn-sm" href="/eventline/month/4" role="button">April</a></div>
						<div class="col"><a class="btn btn-primary btn-sm" href="/eventline/month/5" role="button">May</a></div>
						<div class="col"><a class="btn btn-primary btn-sm" href="/eventline/month/6" role="button">June</a></div>
					</div>
				</div>
					...
					<div class="card-body">
						<div class="crayons-story__body">
							...
							<h2 class="crayons-story__title">
								<a href="/eventline/month/1/day/1" id="article-link-1766481">Event exclusive</a>
							</h2>
